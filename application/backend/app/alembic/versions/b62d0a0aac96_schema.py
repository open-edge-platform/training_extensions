...
def upgrade() -> None:
    ...
    op.create_index('idx_model_revisions_project_status', 'model_revisions', ['project_id', 'training_status'], unique=False)
    ...
    op.create_table('dataset_items_labels',
