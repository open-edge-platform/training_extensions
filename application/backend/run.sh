...
VIDEO_URLS["$DETECTION_VIDEO_TARGET"]="$DETECTION_VIDEO_URL"
VIDEO_URLS["$SEGMENTATION_VIDEO_TARGET"]="$SEGMENTATION_VIDEO_URL"

# Model base URLs and target directories
declare -A MODEL_CONFIGS
MODEL_CONFIGS["$DETECTION_MODEL_TARGET_DIR"]="$DETECTION_MODEL_BASE_URL"
MODEL_CONFIGS["$SEGMENTATION_MODEL_TARGET_DIR"]="$SEGMENTATION_MODEL_BASE_URL"
