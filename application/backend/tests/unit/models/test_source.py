...
from app.models.source import IP_CAMERA_PASSWORD, IP_CAMERA_USERNAME, IPCameraConfig
...
def test_get_configured_stream_url_invalid_credentials(fxt_ip_camera_source_config, env_vars, description):
    ...
    with (
        ...
        fxt_ip_camera_source_config.config_data.get_configured_stream_url()


@patch.dict(os.environ, {IP_CAMERA_USERNAME: "testuser", IP_CAMERA_PASSWORD: "testpass"})
def test_different_url_schemes(fxt_ip_camera_source_config):
    ...
    for input_url, expected_url in test_cases:
        fxt_ip_camera_source_config.config_data.stream_url = input_url

        result = fxt_ip_camera_source_config.config_data.get_configured_stream_url()
