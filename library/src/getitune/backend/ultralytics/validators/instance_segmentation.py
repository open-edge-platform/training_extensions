...
class SegmentationValidator(_UltralyticsSegmentationValidator):
    ...
    def _run_standalone_eval(self, model: object) -> dict:
        ...
        Same as DetectionValidator._run_standalone_eval but builds the
        adapter with ``include_masks=True``.
        """
        self.training = False
    ...
    def _build_adapter_dataloader(self) -> DataLoader:
        ...
        adapter = UltralyticsDatasetAdapter(subset, include_masks=True)
        return DataLoader(
            adapter,
