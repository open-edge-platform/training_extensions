...
<<<<<<<< HEAD:library/src/getitune/backend/lightning/models/classification/hlabel_models/timm_model.py
...
>>>>>>>> develop:library/src/getitune/backend/native/models/classification/hlabel_models/timm_model.py
