...
<<<<<<<< HEAD:library/src/getitune/backend/lightning/models/detection/layers/elan_layer.py
...
>>>>>>>> develop:library/src/getitune/backend/native/models/detection/layers/elan_layer.py
