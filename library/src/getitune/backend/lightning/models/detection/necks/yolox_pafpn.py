...
<<<<<<<< HEAD:library/src/getitune/backend/lightning/models/detection/necks/yolox_pafpn.py
...
>>>>>>>> develop:library/src/getitune/backend/native/models/detection/necks/yolox_pafpn.py
