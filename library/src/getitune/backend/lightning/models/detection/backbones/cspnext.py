...
<<<<<<<< HEAD:library/src/getitune/backend/lightning/models/detection/backbones/cspnext.py
...
>>>>>>>> develop:library/src/getitune/backend/native/models/detection/backbones/cspnext.py
