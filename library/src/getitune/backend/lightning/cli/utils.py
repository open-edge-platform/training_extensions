...
def list_models(
    task: TaskType | None = None, pattern: str | None = None, print_table: bool = False, return_recipes: bool = False
) -> list[str]:
    ...
    """
    task_type = TaskType(task).name.lower() if task is not None else "**"
    recipe_list = [
