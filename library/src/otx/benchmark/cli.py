...
"""CLI for the benchmark runner: ``python -m otx.benchmark <subcommand>``."""
...
def _build_parser() -> argparse.ArgumentParser:
    top = argparse.ArgumentParser(
        prog="python -m otx.benchmark",
        description="OTX Automated Model Benchmarking",
    )
...
def _cmd_provision(args: argparse.Namespace) -> int:
    from otx.benchmark.catalog import load_catalog, provision_datasets
...
def _cmd_run(args: argparse.Namespace) -> int:
    ...
    from otx.benchmark.manifest import ManifestFilters, load_manifest
...
def _cmd_report(args: argparse.Namespace) -> int:
    ...
    from otx.benchmark.manifest import load_manifest
    from otx.benchmark.report import generate_report
    from otx.benchmark.tracking import BenchmarkTracker, TrackingConfig, get_git_branch, get_git_sha
    ...
    if args.output:
        from otx.benchmark.report import generate_markdown
...
def main() -> None:
    """CLI entry point for ``python -m otx.benchmark``."""
