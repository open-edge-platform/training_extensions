...
They are slow (~10-30s per model due to compilation overhead) and test PyTorch
infrastructure compatibility rather than model logic, so they belong in integration tests.
"""
