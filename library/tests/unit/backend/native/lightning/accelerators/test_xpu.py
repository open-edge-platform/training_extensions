...
from getitune.backend.native.lightning.accelerators import XPUAccelerator
...
class TestXPUAccelerator:
    ...
    def accelerator(self, mocker):
        mock_torch = mocker.patch("getitune.backend.native.lightning.accelerators.xpu.torch")
