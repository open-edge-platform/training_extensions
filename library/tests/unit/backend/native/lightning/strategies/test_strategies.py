...
from getitune.backend.native.lightning.strategies import xpu_single as target_file
from getitune.backend.native.lightning.strategies.xpu_single import SingleXPUStrategy
