...
from getitune.backend.lightning.lightning.strategies import xpu_single as target_file
from getitune.backend.lightning.lightning.strategies.xpu_single import SingleXPUStrategy
