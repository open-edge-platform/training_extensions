...
from getitune.backend.lightning.models.common.backbones.pytorchcv_backbones import (
...
def test_replace_norm(mocker) -> None:
    mocker.patch(
        "getitune.backend.lightning.models.common.backbones.pytorchcv_backbones.build_norm_layer",
