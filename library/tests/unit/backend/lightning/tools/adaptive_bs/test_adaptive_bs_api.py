...
from getitune.backend.lightning.tools.adaptive_bs import runner as target_file
from getitune.backend.lightning.tools.adaptive_bs.runner import (
    BatchSizeFinder,
    _adjust_train_args,
    _train_model,
    adapt_batch_size,
...
def test_adapt_batch_size_cpu(
    ...
    mock_logger = mocker.patch("getitune.backend.lightning.tools.adaptive_bs.runner.logger")
    adapt_batch_size(mock_engine, **train_args)
