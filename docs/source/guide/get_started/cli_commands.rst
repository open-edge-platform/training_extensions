...
.. code-block:: shell
    ...
    │ Options:                                                                                                                                                                                  │
    │   -h, --help            Show this help message and exit.                                                                                                                                  │
    │   --task {ANOMALY,MULTI_CLASS_CLS,MULTI_LABEL_CLS,H_LABEL_CLS,DETECTION,ROTATED_DETECTION,KEYPOINT_DETECTION,INSTANCE_SEGMENTATION,SEMANTIC_SEGMENTATION,VISUAL_PROMPTING},               │
