...
- ``Additional training techniques``
    ...
    - `Balanced Sampler <https://github.dev/open-edge-platform/training_extensions/blob/develop/src/otx/algo/samplers/balanced_sampler.py#L11>`_: To create an efficient batch that consists of balanced samples over classes, reducing the iteration size as well.
