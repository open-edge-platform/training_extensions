...
"""Unit test for NuSVR model wrapper with OpenVINO optimization for OTX."""
...
from otx.backend.openvino.models.sklearn import NuSVR
...
class TestNuSVR(unittest.TestCase):
    def test_nusvr(self):
        ...
        model = NuSVR(**params, use_openvino=True)
        start = timer()
        ...
        from sklearn.svm import NuSVR as SkNuSVR
        base_model = SkNuSVR(**params)
        start = timer()
