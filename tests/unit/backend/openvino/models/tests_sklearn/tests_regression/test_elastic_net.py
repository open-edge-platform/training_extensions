...
"""Unit test for ElasticNet model wrapper with OpenVINO optimization for OTX."""
...
from otx.backend.openvino.models.sklearn  import ElasticNet
...
class TestElasticNet(unittest.TestCase):
    def test_elastic_net(self):
        ...
        model = ElasticNet(**params, use_openvino=True)
        start = timer()
