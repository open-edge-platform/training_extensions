...
"""Unit test for LinearRegression model wrapper with OpenVINO optimization for OTX."""
...
from otx.backend.openvino.models.sklearn import LinearRegression
...
class TestLinearRegression(unittest.TestCase):
    def test_linear_regression(self):
        ...
        model = LinearRegression(**params, use_openvino=True)
        start = timer()
