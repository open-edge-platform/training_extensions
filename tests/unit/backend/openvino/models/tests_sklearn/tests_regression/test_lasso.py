...
"""Unit test for Lasso model wrapper with OpenVINO optimization for OTX."""
...
from otx.backend.openvino.models.sklearn import Lasso
...
class TestLasso(unittest.TestCase):
    def test_lasso(self):
        ...
        model = Lasso(**params, use_openvino=True)
        start = timer()
