...
"""Unit test for RandomForestRegressor model wrapper with OpenVINO optimization for OTX."""
...
from otx.backend.openvino.models.sklearn import RandomForestRegressor
...
class TestRandomForestRegressor(unittest.TestCase):
    def test_random_forest_regressor(self):
        ...
        model = RandomForestRegressor(**params, use_openvino=True)
        start = timer()
