...
"""Unit test for LogisticRegression model wrapper with OpenVINO optimization for OTX."""
...
from otx.backend.openvino.models.sklearn import LogisticRegression
...
class TestLogisticRegression(unittest.TestCase):
    def test_logistic_regression(self):
        ...
        params = {}
        model = LogisticRegression(**params, use_openvino=True)
        start = timer()
