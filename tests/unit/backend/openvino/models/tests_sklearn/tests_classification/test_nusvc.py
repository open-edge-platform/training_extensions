...
"""Unit test for NuSVC model wrapper with OpenVINO optimization for OTX."""
...
from otx.backend.openvino.models.sklearn import NuSVC
...
class TestNuSVC(unittest.TestCase):
    def test_nusvc(self):
        ...
        params = {"kernel": "rbf"}
        model = NuSVC(**params, use_openvino=True)
        start = timer()
