...
"""Unit test for RandomForestClassifier model wrapper with OpenVINO optimization for OTX."""
...
from otx.backend.openvino.models.sklearn import RandomForestClassifier
...
class TestRandomForestClassifier(unittest.TestCase):
    def test_random_forest_classifier(self):
        ...
        model = RandomForestClassifier(**params, use_openvino=True)
        start = timer()
