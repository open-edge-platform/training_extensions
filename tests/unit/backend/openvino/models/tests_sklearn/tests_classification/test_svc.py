...
"""Unit test for SVC model wrapper with OpenVINO optimization for OTX."""
...
from otx.backend.openvino.models.sklearn import SVC
...
class TestSVC(unittest.TestCase):
    def test_svc(self):
        ...
        params = {"kernel": "rbf"}
        model = SVC(**params, use_openvino=True)
        start = timer()
