...
class ValidateBatchMixin:
    ...
    @staticmethod
    def _labels_validator(label_batch: list[torch.Tensor | None]) -> list[torch.Tensor]:
    ...
    @staticmethod
    def _imgs_infos_validator(imgs_infos_batch: list[ImageInfo | None]) -> list[ImageInfo]:
