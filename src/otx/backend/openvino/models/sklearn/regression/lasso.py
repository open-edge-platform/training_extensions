...
from sklearnex.linear_model import Lasso as SkModel
...
class Lasso:
    def __init__(self, *args, use_openvino=True, **kwargs):
        ...
        print("📦 Lasso model initialized (OpenVINO version).")
    ...
    def convert_to_ir(self, X_train, model_name="lasso"):
        """
        Convert the trained Lasso model to OpenVINO IR format via an equivalent neural network.
