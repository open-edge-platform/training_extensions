...
class OTXDataset(Dataset):
    ...
    def _apply_transforms(self, entity: OTXDataItem | OTXDataItem) -> OTXDataItem | OTXDataItem | None:
    ...
    def _iterable_transforms(self, item: OTXDataItem | OTXDataItem) -> OTXDataItem | OTXDataItem | None:
    ...
    def __getitem__(self, index: int) -> OTXDataItem | OTXDataItem:
